...
export const linkedinData = [
    ...
    },
    {
        ...
        image:img_37,
        description:
            "Completing the Full Stack Data Science and AI course at SocialPrachar was one of the best decisions I’ve made for my career. The trainers are true experts who went above and beyond to ensure I understood every concept. The curriculum was top-notch, with a perfect blend of theory, hands-on projects, and interview preparation. The placement support team was incredibly helpful, guiding me every step of the way. I’m thrilled to have started my career in tech, all thanks to SocialPrachar. Highly recommended!",
    }   
];
