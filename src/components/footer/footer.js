                    ...
                    <div className={`row ${footerStyle.fotterList}`}>
                        <div className={`col-12 col-sm-12 col-md-6 col-lg-3`}>
                            <div>
                                ...
                                <p>
                                    SocialPrachar, founded by an IIM alumnus, is a leading EdTech company with 10+ years of expertise. We’ve trained 16,000+ students and achieved a 95% placement success rate with packages ranging from ₹3 to ₹12 LPA. Offering cutting-edge programs in Full Stack, Data Science, AI, and Cloud, we are committed to transforming careers with quality education and industry connections.
                                </p>
                            </div>
