            ...
            <div className="container py-5">
                ...
                <div className="my-5">
                    ...
                    <div className="text-center mt-5">
                        <p className="lead">
                            With SocialPrachar and SocialHire, you&rsquo;re not just learning; you&rsquo;re building a future. Join us today and take the first step toward achieving your dream job!
                        </p>
                    </div>
